...
const columns: Column<any>[] = [
  ...
  { key: "requestStatus", label: "Status",render: (value) => (
  ...
  return (
    <div>
      <div className='flex gap-4 items-center mb-6'>
        ...
        <p className='font-bold text-[32px]'>Requests Report</p>
      </div>
        ...
        expandedContent={(row) => (
          <div className="grid grid-cols-2 gap-4 max-w-md">
            ...
            <p className="text-sm text-zinc-600">{row.authorizer}</p>
                <p className="text-sm font-medium text-zinc-700">Date Authorized</p>
                <p className="text-sm text-zinc-600">{row.dateApproved}</p>
                <p className="text-sm font-medium text-zinc-700">Transaction Status</p>
                <p className="text-sm text-zinc-600">{row.transactionStatus}</p>
          </div>
        )}
