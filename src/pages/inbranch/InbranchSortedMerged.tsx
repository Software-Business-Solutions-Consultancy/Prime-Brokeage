...
import { ArrowDownWideNarrow, SendHorizonal, ThumbsUp } from 'lucide-react'
      ...
      <p className="text-[#FF0000] mb-[30px]">Sorting and Merge Output</p>
          ...
          <BloombergMergedTable
            ...
            />
                    ...
                    <Button onClick={() => confirmSortMatch()} icon={<SendHorizonal/>} className='bg-gradient-to-r from-[#FF8200] to-[#FF002B] mt-4'>Send For Payment </Button>
...
export default InbranchSortedMerged
